      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-20">
          ...
          >
            ...
            <span className="font-bold text-xl tracking-tight text-slate-900 dark:text-white">Focus<span className="text-cyan-600 dark:text-cyan-400">Electrical</span></span>
          </button>
          ...
          <div className="hidden md:flex items-center space-x-8">
            <button 
              onClick={() => handleNavClick('#home')}
              className={`text-sm font-medium transition-colors ${currentPage === 'home' && !window.location.hash ? 'text-cyan-600 dark:text-cyan-400' : 'text-slate-600 dark:text-slate-300 hover:text-cyan-600 dark:hover:text-cyan-400'}`}
            >
              Home
            </button>
            <button 
              onClick={() => handleNavClick('#products')}
              className={`text-sm font-medium transition-colors ${currentPage === 'products' ? 'text-cyan-600 dark:text-cyan-400' : 'text-slate-600 dark:text-slate-300 hover:text-cyan-600 dark:hover:text-cyan-400'}`}
            >
              Products
            </button>
            <button 
              onClick={() => handleNavClick('#about')}
              className={`text-sm font-medium transition-colors ${currentPage === 'about' ? 'text-cyan-600 dark:text-cyan-400' : 'text-slate-600 dark:text-slate-300 hover:text-cyan-600 dark:hover:text-cyan-400'}`}
            >
              About Us
            </button>
            ...
            {NAV_ITEMS.map((item) => (
              <button 
                ...
                className={`text-sm font-medium transition-colors focus:outline-none ${currentPage === 'news' && item.href === '#news' ? 'text-cyan-600 dark:text-cyan-400' : 'text-slate-600 hover:text-cyan-600 dark:text-slate-300 dark:hover:text-cyan-400'}`}
              >
                {item.label}
              </button>
            ))}
              ...
              {themeMenuOpen && (
                <div className="absolute right-0 mt-2 w-36 rounded-xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 shadow-lg py-1 z-50">
                  <button 
                    ...
                    className={`flex items-center gap-2 w-full px-4 py-2 text-sm ${theme === 'light' ? 'text-cyan-600 dark:text-cyan-400 bg-cyan-50 dark:bg-cyan-900/20' : 'text-slate-700 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-800'}`}
                  >
                    <Sun className="h-4 w-4" /> Light
                  </button>
                  <button 
                    onClick={() => { setTheme('dark'); setThemeMenuOpen(false); }}
                    className={`flex items-center gap-2 w-full px-4 py-2 text-sm ${theme === 'dark' ? 'text-cyan-600 dark:text-cyan-400 bg-cyan-50 dark:bg-cyan-900/20' : 'text-slate-700 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-800'}`}
                  >
                    <Moon className="h-4 w-4" /> Dark
                  </button>
                  <button 
                    onClick={() => { setTheme('system'); setThemeMenuOpen(false); }}
                    className={`flex items-center gap-2 w-full px-4 py-2 text-sm ${theme === 'system' ? 'text-cyan-600 dark:text-cyan-400 bg-cyan-50 dark:bg-cyan-900/20' : 'text-slate-700 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-800'}`}
                  >
            ...
            {user ? (
               <div className="relative">
                 <button 
                    ...
                    className="flex items-center gap-2 pl-2 pr-1 py-1 rounded-full border border-slate-200 dark:border-slate-800 hover:border-cyan-500 transition-colors"
                 >
      ...
      {isOpen && (
        <div className="md:hidden bg-white dark:bg-slate-900 border-b border-slate-200 dark:border-slate-800 shadow-xl">
          <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
            <button
              onClick={() => handleNavClick('#home')}
              className={`block w-full text-left px-3 py-2 rounded-md text-base font-medium ${currentPage === 'home' ? 'text-cyan-600 dark:text-cyan-400 bg-cyan-50 dark:bg-cyan-900/20' : 'text-slate-600 dark:text-slate-300'}`}
            >
              Home
            </button>
            <button
              onClick={() => handleNavClick('#products')}
              className={`block w-full text-left px-3 py-2 rounded-md text-base font-medium ${currentPage === 'products' ? 'text-cyan-600 dark:text-cyan-400 bg-cyan-50 dark:bg-cyan-900/20' : 'text-slate-600 dark:text-slate-300'}`}
            >
              Products
            </button>
            <button
              onClick={() => handleNavClick('#about')}
              className={`block w-full text-left px-3 py-2 rounded-md text-base font-medium ${currentPage === 'about' ? 'text-cyan-600 dark:text-cyan-400 bg-cyan-50 dark:bg-cyan-900/20' : 'text-slate-600 dark:text-slate-300'}`}
            >
              About Us
            </button>
            {NAV_ITEMS.map((item) => (
              <button 
                key={item.label} 
                onClick={() => handleNavClick(item.href)}
                className={`block w-full text-left px-3 py-2 rounded-md text-base font-medium ${currentPage === 'news' && item.href === '#news' ? 'text-cyan-600 dark:text-cyan-400 bg-cyan-50 dark:bg-cyan-900/20' : 'text-slate-600 dark:text-slate-300 hover:text-slate-900 dark:hover:text-white hover:bg-slate-100 dark:hover:bg-slate-800'}`}
              >
                {item.label}
              </button>
            ))}
