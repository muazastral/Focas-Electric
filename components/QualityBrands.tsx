      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="lg:grid lg:grid-cols-2 lg:gap-16 items-center">
          ...
          <div className="relative mb-12 lg:mb-0">
             <div className="absolute inset-0 bg-cyan-500/10 blur-3xl rounded-full transform -translate-x-1/2"></div>
             <img 
               src="https://picsum.photos/800/800?grayscale&random=10" 
             ...
             <div className="absolute -bottom-6 -right-6 glass-panel p-6 rounded-xl z-20 max-w-xs shadow-xl dark:shadow-none">
               <div className="flex items-center gap-4">
                 <div className="p-3 bg-cyan-500 rounded-full text-white">
          ...
          <div>
            <h2 className="text-3xl md:text-5xl font-bold text-slate-900 dark:text-white mb-6">
              ...
              <span className="text-cyan-600 dark:text-cyan-400">No Compromise.</span>
            </h2>
            ...
            <div className="space-y-6">
              <div className="flex gap-4">
                <ShieldCheck className="w-6 h-6 text-cyan-600 dark:text-cyan-400 flex-shrink-0" />
                <div>
              ...
              <div className="flex gap-4">
                <ThumbsUp className="w-6 h-6 text-cyan-600 dark:text-cyan-400 flex-shrink-0" />
                <div>
